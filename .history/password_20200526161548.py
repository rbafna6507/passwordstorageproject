...
# Main algorithm and ABSTRACTION (with par--takes a username, turns it into bytes for encryption, adds it to a dictionary, saves it to a file, calls allpass to decrypt and display passwords
